    ...
    <section className="py-6">
      <MainContainer>
        {storeMedicines.length === 0 ? (
          <div className="flex items-center justify-center md:h-120 h-50">
            <Link href="/shop">
              <p className="text-orange-600 text-2xl italic">Continue Shop</p>
            </Link>
          </div>
        ) : (
          <div className="grid grid-cols-12 gap-3">
            <div className="space-y-6 col-span-8">
              ...
              {medicines.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center gap-4 bg-gray-200 p-2 rounded-lg justify-between"
                >
